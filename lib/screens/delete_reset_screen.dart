          ...
          children: [
            ...
            Card(
              child: ListTile(
                ...
                subtitle: const Text('Remove all account information'),
                trailing: IconButton(
                  icon: const Icon(Icons.delete_forever),
            ...
            Card(
              child: ListTile(
                ...
                subtitle: const Text('Remove all group categories'),
                trailing: IconButton(
                  icon: const Icon(Icons.delete_forever),
  ...
  Future<void> _showDeleteConfirmation(String dataType) async {
    ...
    switch (dataType) {
      ...
      case 'budgets':
        ...
        message = 'Are you sure you want to delete all budgets? This action cannot be undone.';
        break;
      case 'accounts':
      ...
      case 'groups':
        ...
        message = 'Are you sure you want to delete all groups? This action cannot be undone.';
        break;
      default:
        return;
    }
